...
// ============================================================
  ...
  function showScreen(screenId) {
    ...
    if (screenId === 'system-settings-home-screen') {
      if (typeof window.renderSystemSettingsHome === 'function') {
        window.renderSystemSettingsHome();
      }
    }
    ...
    if (screenId === 'hot-news-screen' && typeof window.renderHotNewsScreen === 'function') {
      window.renderHotNewsScreen();
    }
